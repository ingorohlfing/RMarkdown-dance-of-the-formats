...
the content is the same (compare the html reports for [0](just_code_0.html) to
[1](code_chunkinfo_1.html). The only reason I see for converting with 
`documentation = 1` is that you can directly navigate to a selected chunks 
and easily move back and forth between them.